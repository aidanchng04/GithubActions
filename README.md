[![Run App KhaiShenChng](https://github.com/aidanchng04/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/aidanchng04/GithubActions/actions/workflows/run-app.yaml)
